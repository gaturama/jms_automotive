...
export default function EditProfileScreen({ navigation }: Props) {
  ...
  const [favoritesBrand, setFavoritesBrand] = useState(
  ...
  const handleSave = async () => {
    ...
    try {
      await Promise.all([
        ...
        updateFavoritesBrand(favoritesBrand.trim()),
      ]);
                ...
                >
                  ...
                  <View
                    style={{
                      ...
                      height: 30,
                      borderRadius: 15,
                      backgroundColor: profile.showFavorites
                        ? colors.accent
                  ...
                  >
                    <View
                      style={{
                        ...
                        borderRadius: 13,
                        backgroundColor: "#fff",
                        alignSelf: profile.showFavorites
                          ? "flex-end"
                          : "flex-start",
                      }}
                    />
                ...
                >
                  ...
                  <View
                    style={{
                      ...
                      height: 30,
                      borderRadius: 15,
                      backgroundColor: profile.showStats
                        ? colors.accent
                        : colors.inputBackground,
                      justifyContent: "center",
                      paddingHorizontal: 2,
