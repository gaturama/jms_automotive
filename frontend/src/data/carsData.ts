...
export const MOCK_CARS: Car[] = [
  ...
  },
  {
    ...
    weight: 1895,
    price: 1060000,
    description: "O BMW M5 Competition é a personificação do equilíbrio entre luxo executivo e desempenho extremo. Trata-se de um sedã que, à primeira vista, pode passar despercebido, mas que esconde sob sua aparência elegante uma capacidade dinâmica comparável à de supercarros.",
  },
  {
    _id: "22",
    ...
    weight: 2090,
    price: 1251990,
    description: "O Audi RS6 Avant Performance é a definição perfeita de um carro que desafia categorias. Ele combina a praticidade de uma perua com o desempenho de um supercarro, criando um dos veículos mais versáteis e impressionantes da atualidade.",
  },
  {
    _id: "23",
    ...
    weight: 1240,
    price: 350000,
    description: "O Nissan Silvia S15 Spec-R é um dos esportivos japoneses mais cultuados de todos os tempos, conhecido por seu equilíbrio excepcional, leveza e enorme potencial para preparação. Lançado no fim da era de ouro dos esportivos japoneses, o S15 representa a forma mais refinada da linhagem Silvia, combinando design agressivo, mecânica confiável e uma dirigibilidade que o tornou referência no drift.",
  },
  {
    _id: "24",
    ...
    weight: 1793,
    price: 900000,
    description: "O Volkswagen Arteon Shooting Brake R é a combinação perfeita entre elegância europeia, versatilidade de uma perua e desempenho esportivo de alto nível. Ele representa o lado mais sofisticado e ousado da Volkswagen, trazendo um design refinado aliado à engenharia da divisão R.",
  },
  {
    _id: "25",
    ...
    weight: 1380,
    price: 2000000,
    description: "O Porsche Carrera GT é um dos supercarros mais puros e lendários já produzidos, representando uma era em que a conexão entre homem e máquina era direta, intensa e sem filtros eletrônicos excessivos.",
  }
];
