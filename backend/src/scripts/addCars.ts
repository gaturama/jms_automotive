...
const newCars = [
  ...
  },
  {
    ...
    price: 3000000,
    description:
      "O Acura NSX Type S representa o ápice da segunda geração do lendário NSX, combinando tecnologia híbrida avançada, desempenho de supercarro e a filosofia japonesa de precisão mecânica.",
  },
  {
  ...
  },
  {
    ...
    price: 2039900,
    description:
      "O Mercedes-AMG G63 é um dos SUVs mais icônicos e reconhecíveis do mundo, combinando luxo extremo, presença imponente e desempenho brutal em um veículo com raízes militares.",
  },
  {
    ...
    price: 40000000,
    description:
      "A Ferrari LaFerrari representa o auge da engenharia da Ferrari na era moderna, combinando tecnologia híbrida derivada da Fórmula 1 com um dos motores V12 naturalmente aspirados mais emocionantes já produzidos.",
  },
  {
    ...
    price: 250000,
    description:
      "O Subaru Impreza WRX é um dos esportivos japoneses mais icônicos já produzidos, conhecido por sua forte ligação com o rally, tração integral extremamente eficiente e desempenho acessível",
  },
];
